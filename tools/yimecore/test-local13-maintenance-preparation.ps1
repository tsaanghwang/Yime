...
try {
    ...
    Check ($entryText.Contains("manifest_sha256='8f7e44ab9097a99d938891b507d0a07b753ffa66dbbec887cb0576286470f2cc'") -and $entryText.Contains("manager_sha256='9f69d9aba12e4c50c8aa06edb945375dc72a721cd208791ffab2e4207442f39d'") -and $entryText.Contains("wrapper_sha256='ec206153c53d96b98aa43cd522167bb55eef83b7d7acedf745f8f966c6851479'") -and $entryText.Contains('member_count=85')) 'entry pins reviewed real public candidate'
