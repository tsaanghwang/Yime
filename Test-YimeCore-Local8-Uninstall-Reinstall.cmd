...
echo Uninstall and reinstall the reviewed local.8 package while preserving user data.
...
echo.
"%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe" -NoProfile -ExecutionPolicy Bypass -File "%~dp0tools\yimecore\invoke-local8-uninstall-reinstall.ps1" -Execute
