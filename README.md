...
Current [DP1-O evidence](docs/project/YIME_DUAL_PRODUCT_DP1_O_ISOLATED_CURRENT_CANDIDATE_2026-09-07.md) rebuilds one unsigned, disabled x86/x64 candidate from exact HEAD `ba0e2dc2d42fee66ac4e707800c43c2630794f7a` in a detached clone, statically checks 181 outer and 11 nested-uninstaller entries, and produces a clone-local durable strict receipt-v2. The sealed candidate is `YIME-1.4.0-dev-setup.exe`, 41,431,585 bytes, SHA-256 `c55905a0c0cf518fb4eeda10f69d95c6d357b036461560a051accc67766699e2`; the final runner result SHA-256 is `d922c851ef74895a65424248f176d76d30cdd6cccdd5cd1385f88afdb961af0a`. The runner's protected actual-checkout snapshot did not change. Because the actual and isolated receipts use the same version and installer leaf, the DP1-N distinct-leaf prerequisite is false and actual canonical migration is not admitted. The clone-local process-interruption store is not outer `.tmp` retention or archival evidence, and no installer, adapter, signing, installed/live or hardware/directory-durability gate passed.
...
| [DP1-O Isolated Current Candidate](docs/project/YIME_DUAL_PRODUCT_DP1_O_ISOLATED_CURRENT_CANDIDATE_2026-09-07.md) | Exact-HEAD disabled candidate, static archive evidence, scoped durable receipt and actual-migration blocker |
