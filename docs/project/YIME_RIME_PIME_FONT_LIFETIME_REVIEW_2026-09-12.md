...
2026-09-13 更新：固定事务恢复入口已接入应用退出提示、重新检查和取消，并完成开发端隔离验证，见[新交接说明](YIME_RIME_PIME_APPLICATION_RELEASE_HANDOFF_2026-09-13.md)。下文“待实现”是 2026-09-12 的清查记录；通用安装器和两产品完整维护矩阵仍待接入／验收。
