...
> **2026-09-12 停用：不得再执行本页安装步骤。** 事务 `9fe7f28d-0889-4828-85b5-1f481431b43a` 出现 YimeCore 用户 TIP 缺失和回滚未完成，CI 成功不解除暂停。以下保留为历史执行说明；当前只执行 [失败审阅与只读补证交接](YIME_RIME_PIME_PEER_FAILURE_REVIEW_2026-09-12.md)。
