...
卷舌/鼻化特征”改写规则，形成“儿缀兼容 + 融合儿化”双路线能力。65 条继承三模式核心权重，
在融合层保存两条路线；66 条继承 PSC 外围层精确儿缀记录的固定低权重 `1`，外围层保留儿缀路线，
融合层只增加融合路线。融合附加词典因而每模式 196 条、合计 588 行；131 条均进入融合反查旁表，
...
阶段 0 门禁通过只表示离线基础设施完成；当前运行时包含上述显式词汇化儿化试点，以及不改变核心
排序的 PSC 规范来源低频外围候选。后者保存有来源的轻声/儿化候选读法，不意味着轻声表层调值、
能产儿化、语气词或其他语流音变已经接入运行时。
