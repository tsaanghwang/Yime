...
| 4.3 | 词典噪声清理 | 待做 | 审查权重=1 的极低频词 |
| 4.4 | 非标准音节审查 | 待做 | 确认 bong4/wong4 等是否有对应汉字 |
...
| 5.4 | 词典噪声清理 | 审查并移除权重=1 的极低频词 | 词典工具 |
| 5.5 | 非标准音节审查 | 确认 bong4/wong4 等是否对应汉字 | 词典工具 |
| 5.6 | 组字时数字键选词模式 | 可配置，数字键在"选词"和"编码"间切换 | 编码体系配合 |
