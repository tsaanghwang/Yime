...
| 普通话语流音变处理 | 轻声阶段 3-2 仍停留在 74,535 条三模式临时包；词汇化儿化已另行启动显式来源小规模试点：131 条记录中 29 条双路线就绪，15 条继承三模式权重并生成 90 行正式附加词典；阶段 4A 已用 9 个派生音元、3 个共享键位类和现有布局载体完成 29 条融合路线重投影，未扩大运行词条 | 先补融合儿化可解释反查和 14 条缺权重记录的来源；随后逐类审定 102 条待决融合记录。轻声、能产儿化和鼻化卷舌研究类不得借此试点自动进入运行时 |
